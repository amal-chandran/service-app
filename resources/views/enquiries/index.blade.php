...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ route('enquiries.enquiry.create') }}" class="btn btn-success btn-sm float-right"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="btn-group btn-group-xs float-right" role="group">
                            @can('view-enquiries')
                            <a href="{{ route('enquiries.enquiry.show', $enquiry->id ) }}" class="btn btn-sm btn-info"
                                title="Show Enquiry">
                                <span class="fas fa-eye" aria-hidden="true"></span> Open
                            </a>
                            @endcan
                            @can('edit-enquiries')
                            <a href="{{ route('enquiries.enquiry.edit', $enquiry->id ) }}"
                                class="btn btn-sm btn-primary" title="Edit Enquiry">
