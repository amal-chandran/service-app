    ...
    <div class="card">
        <div class="card-header">
          <h4 class="cards-title mb-0 float-left">Addresses</h4>
            <a href="{{ route('addresses.address.create') }}" class="btn btn-success btn-sm float-right" title="Create New Address">
                        ...
                        <td>
                            ...
                            {!! Form::open([
                                ...
                                <div class="btn-group btn-group-xs float-right" role="group">
                                    <a href="{{ route('addresses.address.show', $address->id ) }}" class="btn btn-sm btn-info" title="Show Address">
                                        <span class="fas fa-eye" aria-hidden="true"></span> Open
                                    </a>
                                    <a href="{{ route('addresses.address.edit', $address->id ) }}" class="btn btn-sm btn-primary" title="Edit Address">
