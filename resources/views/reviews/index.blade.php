...
<div class="card">
    <div class="card-header">
        ...
        @can('create-reviews')
        <a href="{{ route('reviews.review.create') }}" class="btn btn-success btn-sm float-right"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="btn-group btn-group-xs float-right" role="group">
                            @can('view-reviews')
                            <a href="{{ route('reviews.review.show', $review->id ) }}" class="btn btn-sm btn-info"
                                title="Show Review">
                                <span class="fas fa-eye" aria-hidden="true"></span> Open
                            </a>
                            @endcan
                            @can('edit-reviews')
                            <a href="{{ route('reviews.review.edit', $review->id ) }}" class="btn btn-sm btn-primary"
                                title="Edit Review">
