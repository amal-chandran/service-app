...
<div class="card">
    <div class="card-header">
        ...
        @can('create-messages')
        <a href="{{ route('messages.message.create') }}" class="btn btn-success btn-sm float-right"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="btn-group btn-group-xs float-right" role="group">
                            @can('view-messages')
                            <a href="{{ route('messages.message.show', $message->id ) }}" class="btn btn-sm btn-info"
                                title="Show Message">
                                <span class="fas fa-eye" aria-hidden="true"></span> Open
                            </a>
                            @endcan
                            @can('edit-messages')
                            <a href="{{ route('messages.message.edit', $message->id ) }}" class="btn btn-sm btn-primary"
                                title="Edit Message">
